...
const hasValCheck = (
  ...
  const {
    [`zolo_${att}Range`]: deskAtt,
    [`zolo_TAB${att}Range`]: tabAtt,
    [`zolo_MOB${att}Range`]: mobAtt,
  } = attributes;
...
export const AdvancedOptions = (props) => {
  ...
  const displayPanels = applyFilters(
    "zolo.blocks.displayConditions",
    [],
    panelProps
  );
  const animationPanels = applyFilters(
    "zolo.blocks.extraTab.animationPanels",
    [],
    block,
    panelProps
  );
  const cursorsPanel = applyFilters(
    "zolo.extensions.controls.cursors",
    [],
    block,
    panelProps
  );
  const particles = applyFilters(
    "zolo.extensions.controls.particles",
    [],
    block,
    panelProps
  );
  const tilt = applyFilters(
    "zolo.extensions.controls.tilt",
    [],
    block,
    panelProps
  );
  ...
  return (
    <>
      ...
      >
        ...
        <div className="zolo-inline-control-wrapper">
          ...
          <FormTokenField
            ...
            help={__(
              "Add custom class(es) to the block. Separate multiple classes with a space.",
              "zoloblocks"
            )}
          />
        </div>
      ...
      {globalConfig?.background && (
        <ZoloPanelBody
          title={__("Background", "zoloblocks")}
          panelProps={props}
          extraPanel={true}
        >
          <div className="zolo-flex-col-control">
            <BackgroundControl
              ...
              particles={particles}
              video={
                block === "zolo/container" || block === "zolo/slide"
                  ? true
                  : false
              }
            />
        ...
        >
          ...
          {globalConfig?.borderRadius && (
            <ResDimensionsControl
              ...
              controlName={
                globalConfig.borderRadius.prefix || "mainBorderRadius"
              }
              requiredProps={requiredProps}
      ...
      {globalConfig?.responsiveControls && (
        <>
          <ZoloPanelBody
            title={__("Visibility Control", "zoloblocks")}
            panelProps={props}
            extraPanel={true}
          >
            <ToggleControl
            ...
            normalComponents={
              <>
                <PopoverControl
                  ...
                  icon={TRANSLATE_ICON}
                  onReset={() =>
                    resetAtt(["translateX", "translateY"], setAttributes)
                  }
                  hasValue={
                    hasValCheck("translateX", attributes) ||
                    hasValCheck("translateY", attributes)
                  }
                >
                  <ResRangeControl
                ...
                <PopoverControl
                  ...
                  onReset={() =>
                    resetAtt(
                      ["transformScaleX", "transformScaleY", "transformScale"],
                      setAttributes
                    )
                  }
                  hasValue={
                ...
                <PopoverControl
                  ...
                  hasValue={
                    hasValCheck("transformSkewX", attributes) ||
                    hasValCheck("transformSkewY", attributes)
                  }
                >
                  <ResRangeControl
                ...
                <PopoverControl
                  ...
                  hasValue={
                    hasValCheck("transformOriginX", attributes) ||
                    hasValCheck("transformOriginY", attributes)
                  }
                >
                  <ToggleControl
            ...
            hoverComponents={
              <>
                <PopoverControl
                  ...
                  onReset={() =>
                    resetAtt(
                      ["translateXHover", "translateYHover"],
                      setAttributes
                    )
                  }
                  hasValue={
                    hasValCheck("translateXHover", attributes) ||
                    hasValCheck("translateYHover", attributes)
                  }
                >
                  <ResRangeControl
                    label={__("translateX", "zoloblocks")}
      ...
      <ZoloPanelBody
        title={__("Custom CSS", "zoloblocks")}
        panelProps={props}
        extraPanel={true}
        isNew={true}
      >
