...
export const GlobalStyleHanlder = (props) => {
  ...
  const filteredTransitionDurationDesktop = transitionDurationDesktop.replace(
    "px;",
    "ms"
  );
  const filteredTransitionDurationTab = transitionDurationTab.replace(
    "px;",
    "ms"
  );
  const filteredTransitionDurationMob = transitionDurationMob.replace(
    "px;",
    "ms"
  );
  ...
  const positionDesktop = `
        ...
        ${
          position.value == "fixed" || position.value === "absolute"
 ...
 `;
  ...
  const transformStylesDesktop = `
            ...
            ${
              transformRotate3DActive
                ? `${rotateXStylesDesktop} ${rotateYStylesDesktop} ${rotatePerspectiveStylesDesktop}`
                : ""
            }
            ${scaleProportionally ? `${scaleStylesDesktop}` : ""}
            ${
              !scaleProportionally
                ? `${scaleXStylesDesktop} ${scaleYStylesDesktop}`
                : ""
            }
            ${skewXStylesDesktop}
            ${skewYStylesDesktop}
  ...
  const transformStylesTab = `
            ...
            ${
              transformRotate3DActive
                ? `${rotateXStylesTab} ${rotateYStylesTab} ${rotatePerspectiveStylesTab}`
                : ""
            }
            ${scaleProportionally ? `${scaleStylesTab}` : ""}
            ${
              !scaleProportionally
                ? `${scaleXStylesTab} ${scaleYStylesTab}`
                : ""
            }
            ${skewXStylesTab}
            ${skewYStylesTab}
  ...
  const transformStylesMob = `
            ...
            ${
              transformRotate3DActive
                ? `${rotateXStylesMob} ${rotateYStylesMob} ${rotatePerspectiveStylesMob}`
                : ""
            }
            ${scaleProportionally ? `${scaleStylesMob}` : ""}
            ${
              !scaleProportionally
                ? `${scaleXStylesMob} ${scaleYStylesMob}`
                : ""
            }
            ${skewXStylesMob}
            ${skewYStylesMob}
  ...
  const transformStylesDesktopHover = `
            ...
            ${
              transformRotate3DActiveHover
                ? `${rotateXStylesDesktopHover} ${rotateYStylesDesktopHover} ${rotatePerspectiveStylesDesktopHover}`
                : ""
            }
            ${scaleProportionallyHover ? `${scaleStylesDesktopHover}` : ""}
            ${
              !scaleProportionallyHover
                ? `${scaleXStylesDesktopHover} ${scaleYStylesDesktopHover}`
                : ""
            }
            ...
            ${
              filteredTransitionDurationDesktop
                ? `${filteredTransitionDurationDesktop}`
                : ""
            }
  ...
  const transformStylesTabHover = `
            ...
            ${
              transformRotate3DActiveHover
                ? `${rotateXStylesTabHover} ${rotateYStylesTabHover} ${rotatePerspectiveStylesTabHover}`
                : ""
            }
            ${scaleProportionallyHover ? `${scaleStylesTabHover}` : ""}
            ${
              !scaleProportionallyHover
                ? `${scaleXStylesTabHover} ${scaleYStylesTabHover}`
                : ""
            }
            ${skewXStylesTabHover}
            ${skewYStylesTabHover}
  ...
  const transformStylesMobHover = `
            ...
            ${
              transformRotate3DActiveHover
                ? `${rotateXStylesMobHover} ${rotateYStylesMobHover} ${rotatePerspectiveStylesMobHover}`
                : ""
            }
            ${scaleProportionallyHover ? `${scaleStylesMobHover}` : ""}
            ${
              !scaleProportionallyHover
                ? `${scaleXStylesMobHover} ${scaleYStylesMobHover}`
                : ""
            }
            ${skewXStylesMobHover}
            ${skewYStylesMobHover}
  ...
  const desktopGlobalStyles = `
      ...
      ${
        ...
        ${
          widthTypeDesktop == "custom"
            ? `${customWidthDesktop.replace(";", " !important;")} `
            : ""
        }
        }
        `
  ...
  const tabGlobalStyles = `
    ...
    ${
      widthTypeTab !== "default"
        ...
        ${
          widthTypeTab == "custom"
            ? `${customWidthTab.replace(";", " !important;")} `
            : ""
        }
        }
        `
  ...
  const mobileGlobalStyles = `
    ...
    ${
      widthTypeMob !== "default"
        ...
        ${
          widthTypeMob == "custom"
            ? `${customWidthMob.replace(";", " !important;")} `
            : ""
        }
        }
        `
  ...
  const blockWriteCss = customCss
    ? customCss.replace(/{{ZOLO}}/g, `.${uniqueId}`)
    : "";

  const filteredDesktopAllStyle = applyFilters(
    "zolo_desktop_all_style",
    desktopAllStyle,
    props
  );
  const filteredTabAllStyle = applyFilters(
    "zolo_tab_all_style",
    tabAllStyle,
    props
  );
  const filteredMobileAllStyle = applyFilters(
    "zolo_mobile_all_style",
    mobileAllStyle,
    props
  );
  ...
  const softMinifyDeskStrings = softMinifyCssStrings(
    filteredDesktopAllStyle + desktopGlobalStyles
  );
  const softMinifyTabStrings = softMinifyCssStrings(
    filteredTabAllStyle + tabGlobalStyles
  );
  const softMinifyMobStrings = softMinifyCssStrings(
    filteredMobileAllStyle + mobileGlobalStyles
  );

  // Set All Style in "zoloStyles" Attribute
  useEffect(() => {
    const styles = {
      ...(softMinifyDeskStrings && softMinifyDeskStrings !== ""
        ? { desktop: softMinifyDeskStrings }
        : {}),
      ...(softMinifyTabStrings && softMinifyTabStrings !== ""
        ? { tab: softMinifyTabStrings }
        : {}),
      ...(softMinifyMobStrings && softMinifyMobStrings !== ""
        ? { mobile: softMinifyMobStrings }
        : {}),
      ...(blockWriteCss && blockWriteCss !== ""
